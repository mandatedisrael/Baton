...
**Status:** Phases 1–4 complete for the owner-controlled Testnet path. The CLI and project-scoped stdio MCP server share one verified engine for checkpoint, pass, status, log, search, show, resume, and citation verification. Phase 5 identity sharing, revocation, and rotation are next.
