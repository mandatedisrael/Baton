import { z } from "zod";
import { passBaton } from "../cli/commands/pass.js";
...
export function registerWriteTools(server, projectDir) {
    server.registerTool("baton_checkpoint", {
        title: "Checkpoint current agent state",
        description: "Persist a scrubbed self-report checkpoint. Supplied list sections replace latest truth; omitted sections remain unchanged.",
