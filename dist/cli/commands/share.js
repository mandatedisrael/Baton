...
import { grantAccessOnSui } from "../../chain/sharing.js";
import { loadIdentity } from "../../chain/identity.js";
import { BatonError } from "../../core/errors.js";
import { ProjectStore } from "../../store/project.js";
import { ok } from "../output.js";
export async function runShare(cwd, grantee, outputPath, identityPath) {
    ...
    try {
        ...
        throw new BatonError("IO_ERROR", `access was granted on-chain (${result.digest}) but the invitation could not be written to ${path}`, { cause: err });
    }
