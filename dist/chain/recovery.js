...
import { CAPTURE_MODES, parseHandoff, TOOL_IDS } from "../schema/handoff.js";
import { ProjectStore } from "../store/project.js";
import { decryptBlob } from "./decryption.js";
import { fetchVerifiedCiphertext } from "./retrieval.js";
...
function assertManifestMatchesHandoff(manifest, handoff) {
    ...
    const metadataMatches = manifest.branch === (handoff.meta.branch ?? "main") &&
...
function knownEncryptedHash(store, handoffId, descriptor) {
    try {
...
async function recoverBlob(input) {
    ...
    return decryptBlob({
        ...
        policyPackageId: input.remote.policyPackageId,
