...
**Status:** Phases 1–3 core owner path complete on Testnet. Real users can create protected identities, fund storage, register projects, publish encrypted batons and attachments, recover them on a clean machine, verify Sui manifests and plaintext hashes, and resume automatically. Phase 4 MCP exposure is next; sharing, revocation, and rotation remain Phase 5.
